...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        verticalLayout_3->addWidget(bitcoinAtStartup);
        ...
        gridLayout->addWidget(databaseCacheLabel, 0, 0, 1, 1);
        ...
        gridLayout->addLayout(horizontalLayout_2_Main, 0, 1, 1, 1);
        ...
        gridLayout->addWidget(threadsScriptVerifLabel, 1, 0, 1, 1);
        ...
        gridLayout->addLayout(horizontalLayout_3_Main, 1, 1, 1, 1);
        ...
        gridLayout->addWidget(reserveBalanceLabel, 2, 0, 1, 1);

        horizontalLayout_3_Main_3 = new QHBoxLayout();
        horizontalLayout_3_Main_3->setObjectName(QStringLiteral("horizontalLayout_3_Main_3"));
        ...
        horizontalSpacer_3_Main_3 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        horizontalLayout_3_Main_3->addItem(horizontalSpacer_3_Main_3);


        gridLayout->addLayout(horizontalLayout_3_Main_3, 2, 1, 1, 1);
        ...
        verticalLayout_3->addWidget(logEvents);

        horizontalLayout_4_Main = new QHBoxLayout();
        horizontalLayout_4_Main->setObjectName(QStringLiteral("horizontalLayout_4_Main"));
        chainLabel = new QLabel(tabMain);
        chainLabel->setObjectName(QStringLiteral("chainLabel"));

        horizontalLayout_4_Main->addWidget(chainLabel);

        chainId = new QLineEdit(tabMain);
        chainId->setObjectName(QStringLiteral("chainId"));

        horizontalLayout_4_Main->addWidget(chainId);


        verticalLayout_3->addLayout(horizontalLayout_4_Main);
...
#ifndef QT_NO_TOOLTIP
        reserveBalance->setToolTip(QApplication::translate("OptionsDialog", "(0 = auto, <0 = leave that many cores free)", nullptr));
#endif // QT_NO_TOOLTIP
        logEvents->setText(QApplication::translate("OptionsDialog", "Enable  log &events", nullptr));
#ifndef QT_NO_TOOLTIP
        chainLabel->setToolTip(QApplication::translate("OptionsDialog", "Connect to a QtumX blochchain", nullptr));
#endif // QT_NO_TOOLTIP
        chainLabel->setText(QApplication::translate("OptionsDialog", "QtumX chain id:", nullptr));
#ifndef QT_NO_TOOLTIP
        chainId->setToolTip(QApplication::translate("OptionsDialog", "Input the chain id here to start a QtumX blockchain", nullptr));
#endif // QT_NO_TOOLTIP
